...
>
> `specialist skill` 仅在冻结计划明确批准时以“有界原生单元”执行；`child` 侧提出的新 specialist 建议在 `root` 批准前始终是建议态（advisory）。
>
> 你也可以显式表达偏好：
> ```text
...
| | 唯一公开入口 |
|:---:|:---|
| **安装入口** | [⚡ 提示词安装（推荐）](./docs/install/one-click-install-release-copy.md) |
